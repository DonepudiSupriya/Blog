...
mydb=mysql.connector.connect(host='localhost',user='root',password='system',db='flaskblog1')
with mysql.connector.connect(host='localhost',user='root',password='system',db='flaskblog1'):
...
app=Flask(__name__)
app.secret_key="My secret key is too secret"
@app.route("/")
def home():
